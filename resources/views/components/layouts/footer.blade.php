        ...
        <div class="grid gap-12 md:grid-cols-3">
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <ul class="mt-3 space-y-2 text-sm text-white/85">
                    <li><a href="#" class="transition hover:text-brand-400 hover:underline">Aviso Legal</a></li>
                    <li><a href="#" class="transition hover:text-brand-400 hover:underline">Privacidad</a></li>
                    <li><a href="#" class="transition hover:text-brand-400 hover:underline">Contacto</a></li>
                </ul>
            </div>
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <div class="mt-4 flex justify-center gap-4 text-white/85">
                    <a href="#" aria-label="Instagram" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/25 transition hover:border-brand-400 hover:text-brand-400">
                    ...
                    <a href="#" aria-label="X / Twitter" class="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/25 transition hover:border-brand-400 hover:text-brand-400">
                        <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
